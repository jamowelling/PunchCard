            ...
            connect: function (options) {
                ...
                this.doPromise(options, function (onSuccess, onError, timeout) {
                    if (!me.connected) {
                        ...
                        return onError({msg: 'Already connected'});
                    }
                });
...
// >>> http://terminal.ingenico.com/service/local.device.chip0/ingenico.device.chip.Chip/start 
            ...
            off: function (eventName, handler, context) {
                ...
                function remove (eventName) {
                    ...
                    // Remove event
                    me.evtSource.removeEventListener(eventName, handler || sse[eventName].callback.bind(context), false);
        ...
        weblet: {
            ...
            off: function (eventName, handler, context) {
                function remove (eventName) {
                    ...
                    window.removeEventListener(eventName, handler || events[eventName].callback, context || events[eventName].context);
            ...
            function Waas () {
                ...
                var Send = function (method) {
                    this.sendResponse = function (data) {
                        http.post(opts.waasUrl + '/waas/' + interfaceName + '/' + method, data);
                        return this;
                    };
                    this.sendEvent    = function (eventName, data) {
                        http.post(opts.waasUrl + '/waas/' + eventName, data);
                        return this;
                    };
                };
    ...
    tetra.service({ // Instantiate desktopenv service
